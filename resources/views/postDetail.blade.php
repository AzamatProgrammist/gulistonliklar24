      ...
      <div class="container">
        <div class="news__wrapper basic-flex">
          <div class="article__wrapper">
            ...
            <span class="article__date basic-flex">{{ $post->created_at->format('H:s / d.m.Y')}} view: {{ $post->view }}</span>
            ...
            <div class="related-posts basic-flex">
              ...
              <div class="posts__item">
                <a href="{{ route('postDetail', $otherPost->slug) }}">
                  ...
                  <span class="posts__date">{{ $otherPost->created_at->format('H:s / d.m.Y') }}</span>
                </a>
              </div>
              @endforeach
            </div>
