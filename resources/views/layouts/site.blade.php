...
<head>
  ...
  <title>@yield('title') - GILISTONLIKLAR24</title>
  ...
  <main>
    <header class="main-header">
      <div class="container">
        ...
        <a href="{{ $ad->ulr1 }}" class="advertisement-box" style="background-image: url(/site/images/posts/{{ $ad->image1 }})">
          <h4>{{ $ad->title1 }}</h4>
        </a>
      </div>
    </header>
  ...
  <footer class="footer">
    <div class="container">
      <div class="footer__top basic-flex">
        <a href="#" class="footer_logo"><img src="img/loo-blue.png" alt="GILISTONLIKLAR24"></a>
